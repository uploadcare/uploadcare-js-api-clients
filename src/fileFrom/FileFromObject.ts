...
export class FileFromObject
  ...
  constructor(
    ...
    uploadLifecycle: LifecycleInterface<UploadcareFileInterface>
  ) {
    this.settings = settings

    const multipartMinFileSize =
      settings.multipartMinFileSize || defaultSettings.multipartMinFileSize
